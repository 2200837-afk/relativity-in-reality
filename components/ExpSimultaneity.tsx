  ...
  return (
    <div className="space-y-6 animate-in fade-in zoom-in-95 duration-300">
      <div className="bg-space-800 p-6 rounded-xl border border-space-700">
        ...
        {/* 3D AR Canvas */}
        <div className="relative w-full h-[350px] bg-space-900 rounded-xl overflow-hidden border border-space-600 shadow-2xl">
        ...
        <div className="mt-6 flex flex-col lg:flex-row gap-4">
            ...
            {/* Explanation Text */}
            <div className="flex-1 bg-green-900/10 p-4 rounded border border-green-500/20">
