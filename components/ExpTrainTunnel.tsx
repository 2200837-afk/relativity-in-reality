  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-300">
      <div className="bg-space-800 p-6 rounded-xl border border-space-700">
        ...
        {/* 3D AR Canvas */}
        <div className="relative w-full h-[300px] bg-black rounded-xl overflow-hidden border border-space-600 shadow-2xl mb-6">
        ...
        <div className="space-y-4">
             ...
             <div className="flex flex-col lg:flex-row gap-4">
                 ...
                 <div className="flex-1 bg-blue-900/10 p-4 rounded border border-blue-500/20">
