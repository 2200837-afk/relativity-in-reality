  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-300">
      <div className="bg-space-800 p-6 rounded-xl border border-space-700">
        ...
        {/* 3D Viewport */}
        <div className="relative w-full h-[300px] bg-black rounded-xl overflow-hidden border border-space-600 shadow-inner group">
        ...
        <div className="mt-8 space-y-6">
          ...
          />
           ...
           <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="flex-1 bg-space-900 p-4 rounded border border-space-600">
                ...
                {/* Explanation Text */}
                <div className="flex-1 bg-cyan-900/10 p-4 rounded border border-cyan-500/20">
